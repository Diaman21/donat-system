...
> ⚠️ **С покупками СОЗНАТЕЛЬНО не связан.** `purchases.order_id` остаётся NULL всегда —
> иначе в флоу закупки полезет шаг «к какому заказу», и данные коридора замусорятся.
